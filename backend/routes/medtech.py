...
Wholesale / Retail / D2C, Revenue Type, Generated By, Client Name, GST
Number, line items (product name/qty/price), and an optional Invoice
upload (PDF/image/Word doc). See DEPARTMENT_CONFIG['MedTech'] in models.py.
