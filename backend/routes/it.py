...
Web Services / Portal Services / Others, Revenue Type, Generated By
(employee name), Client Name, and an optional Invoice upload (PDF/image/
Word doc). See DEPARTMENT_CONFIG['IT'] in models.py.

Create/update use multipart/form-data (not JSON) so the invoice file can be
sent alongside the other fields in one request.
"""
